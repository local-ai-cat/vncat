...
public protocol FramebufferViewControllerDelegate: AnyObject {
	...
	func framebufferViewControllerDidRequestPaste(_ framebufferViewController: FramebufferViewController,
												  text: String)
}
